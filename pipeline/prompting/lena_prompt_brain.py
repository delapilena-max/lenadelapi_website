...
SCENE_EVIDENCE_CONTRACTS: dict = {
    ...
    'apartment doorway': {
        ...
        'environment_realism_notes': 'coat rack, small entry table, potted plant near door, warm interior light',
    ...
    'coffee shop': {
        ...
        'environment_realism_notes': 'condensation on window, handwritten menu board, tiled floor, street blurred outside',
        'photo_realism_notes': '50mm candid at counter, soft background blur, cloudy window light',
    ...
    'rainy street': {
        ...
        'photo_realism_notes': 'full-body cinematic, motion, rain on coat, reflective puddles, overcast grading',
    ...
    'rooftop sunset': {
        ...
        'environment_realism_notes': 'concrete planters, lounge furniture, skyline background, warm sunset haze',
        'photo_realism_notes': '70mm lifestyle portrait, warm rim light, shallow DOF, skyline softly blurred',
    ...
    'car moment': {
        ...
        'environment_realism_notes': 'soft dashboard shadows, neutral leather interior, city blurred through rain-specked glass',
    ...
    'studio desk': {
        ...
        'environment_realism_notes': 'large monitor, notebook, iced coffee, warm desk lamp, pinned inspiration blurred',
        'photo_realism_notes': '35mm modern creator portrait, late afternoon window + desk lamp mix',
    ...
    'night out': {
        ...
        'environment_realism_notes': 'dark marble, warm sconces, brushed brass fixtures, blurred doorway behind',
        'photo_realism_notes': 'flash-adjacent nightlife editorial, 35mm, mirror reflections, warm controlled highlights',
    ...
    'skincare evening': {
        ...
        'photo_realism_notes': '85mm close-up beauty, realistic skin detail, water droplets, robe or towel fabric',
    ...
    'gym cooldown': {
        ...
        'environment_realism_notes': 'rubber flooring, soft mirrors, stacked towels, sunlight from high windows',
        'photo_realism_notes': '50mm candid wellness photo, low angle, clean morning studio light',
    ...
    'laundry day': {
        ...
        'environment_realism_notes': 'chrome machines, checker tile floor, fluorescent softened by daylight, paperback nearby',
        'photo_realism_notes': '35mm cinematic slice-of-life, candid, mixed fluorescent + daylight color',
    ...
    'museum afternoon': {
        ...
        'environment_realism_notes': 'polished concrete floors, white walls, soft benches, visitors blurred in distance',
        'photo_realism_notes': '50mm editorial culture portrait, balanced composition, soft museum track lighting',
    ...
    'flower shop': {
        ...
        'photo_realism_notes': '85mm romantic street portrait, shallow background blur, bright soft morning light',
    ...
    'record store': {
        ...
        'environment_realism_notes': 'moody narrow aisles, posters on wall, warm lamps, stacks of albums',
        'photo_realism_notes': '35mm grainy editorial, candid side angle, warm low store lighting, film grain',
    ...
    'city bench': {
        ...
        'environment_realism_notes': 'tree-lined city block, brownstones, parked bikes, early fall leaves, soft traffic blur',
        'photo_realism_notes': '85mm street-style portrait, dappled late morning sunlight, candid framing',
    ...
    'elevator moment': {
        ...
        'environment_realism_notes': 'brushed metal walls, warm overhead lights, subtle city reflection in mirrored panel',

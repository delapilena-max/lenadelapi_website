...
def _validate_reconciliation_artifact(
    ...
    decision = {
        ...
        "decision_expires_at_utc": expires_at_value.isoformat(),
        "decision_id": "",
        ...
        "selected_candidate_recipe_id": chosen_recipe_id,
        "selected_candidate_slot_id": chosen_slot_id,
        ...
        "selected_candidate_prompt_sha256": str(reconciliation.get("selected_candidate_prompt_sha256", "")).strip(),

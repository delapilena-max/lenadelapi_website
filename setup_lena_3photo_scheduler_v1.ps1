<#
.SYNOPSIS
    Creates three Lena publish-slot Windows Scheduled Tasks, all DISABLED by default.
...
.EXAMPLE
    ...
    # Register all three tasks (disabled) - must be Admin:
    ...
    # Remove all three tasks if needed:
    #   foreach ($n in @('Lena Publish Morning Slot','Lena Publish Afternoon Slot','Lena Publish Evening Slot')) {
...
Write-Host ''
Write-Host '========================================================'
Write-Host '  Lena Publish Scheduler Setup v1'
Write-Host '  All tasks created DISABLED. Nothing runs yet.'
Write-Host "  Root: $ROOT"
Write-Host '========================================================'
Write-Host ''

# ── Task 1: Morning Publish (09:00 AM) ────────────────────────────────────────
...
# ── Task 2: Afternoon Publish (02:00 PM) ──────────────────────────────────────
#   Enable-ScheduledTask -TaskName 'Lena Publish Afternoon Slot'
...
# ── Task 3: Evening Publish (07:30 PM) ────────────────────────────────────────
#   Enable-ScheduledTask -TaskName 'Lena Publish Evening Slot'
...
# ── Done ──────────────────────────────────────────────────────────────────────
Write-Host ''
Write-Host 'Done. Three tasks created, all DISABLED.'
Write-Host ''
